...
import org.openmrs.module.ssemrreports.reporting.library.data.definition.BMIDataDefinition;
...
public class BMIDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "SELECT client_id, MID(MAX(CONCAT(encounter_datetime, bmi)), 20) as bmi FROM ssemr_etl.ssemr_flat_encounter_hiv_care_follow_up "
