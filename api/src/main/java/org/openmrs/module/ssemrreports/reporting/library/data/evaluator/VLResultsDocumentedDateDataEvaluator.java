...
public class VLResultsDocumentedDateDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "SELECT client_id, max(date_vl_sample_collected) as documented_date FROM ssemr_etl.ssemr_flat_encounter_hiv_care_follow_up where encounter_datetime <= :endDate group by client_id";
