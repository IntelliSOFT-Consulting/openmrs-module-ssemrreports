...
public class ArtDatasetDefinition extends SSEMRBaseDataSet {
	...
	SSEMRBaseDataSet.ColumnParameters maleInfants = new SSEMRBaseDataSet.ColumnParameters(null, "<1, Male", "gender=M|age=<1", "");
	SSEMRBaseDataSet.ColumnParameters femaleInfants = new SSEMRBaseDataSet.ColumnParameters(null, "<1, Female", "gender=F|age=<1", "");

	SSEMRBaseDataSet.ColumnParameters male_1_to_4 = new SSEMRBaseDataSet.ColumnParameters(null, "1-4, Male", "gender=M|age=1-4", "");
	SSEMRBaseDataSet.ColumnParameters female_1_to_4 = new SSEMRBaseDataSet.ColumnParameters(null, "1-4, Female", "gender=F|age=1-4", "");

	SSEMRBaseDataSet.ColumnParameters male_5_to_9 = new SSEMRBaseDataSet.ColumnParameters(null, "5-9, Male", "gender=M|age=5-9", "");
	SSEMRBaseDataSet.ColumnParameters female_5_to_9 = new SSEMRBaseDataSet.ColumnParameters(null, "5-9, Female", "gender=F|age=5-9", "");

	SSEMRBaseDataSet.ColumnParameters male_10_to_14 = new SSEMRBaseDataSet.ColumnParameters(null, "10-14, Male", "gender=M|age=10-14", "");
	SSEMRBaseDataSet.ColumnParameters female_10_to_14 = new SSEMRBaseDataSet.ColumnParameters(null, "10-14, Female", "gender=F|age=10-14", "");

	SSEMRBaseDataSet.ColumnParameters male_15_to_19 = new SSEMRBaseDataSet.ColumnParameters(null, "15-19, Male", "gender=M|age=15-19", "");
	SSEMRBaseDataSet.ColumnParameters female_15_to_19 = new SSEMRBaseDataSet.ColumnParameters(null, "15-19, Female", "gender=F|age=15-19", "");

	SSEMRBaseDataSet.ColumnParameters male_20_to_24 = new SSEMRBaseDataSet.ColumnParameters(null, "20-24, Male", "gender=M|age=20-24", "");
	SSEMRBaseDataSet.ColumnParameters female_20_to_24 = new SSEMRBaseDataSet.ColumnParameters(null, "20-24, Female", "gender=F|age=20-24", "");

	SSEMRBaseDataSet.ColumnParameters male_25_to_29 = new SSEMRBaseDataSet.ColumnParameters(null, "25-29, Male", "gender=M|age=25-29", "");
	SSEMRBaseDataSet.ColumnParameters female_25_to_29 = new SSEMRBaseDataSet.ColumnParameters(null, "25-29, Female", "gender=F|age=25-29", "");

	SSEMRBaseDataSet.ColumnParameters male_30_to_34 = new SSEMRBaseDataSet.ColumnParameters(null, "30-34, Male", "gender=M|age=30-34", "");
	SSEMRBaseDataSet.ColumnParameters female_30_to_34 = new SSEMRBaseDataSet.ColumnParameters(null, "30-34, Female", "gender=F|age=30-34", "");

	SSEMRBaseDataSet.ColumnParameters male_35_to_39 = new SSEMRBaseDataSet.ColumnParameters(null, "35-39, Male", "gender=M|age=35-39", "");
	SSEMRBaseDataSet.ColumnParameters female_35_to_39 = new SSEMRBaseDataSet.ColumnParameters(null, "35-39, Female", "gender=F|age=35-39", "");

	SSEMRBaseDataSet.ColumnParameters male_40_to_44 = new SSEMRBaseDataSet.ColumnParameters(null, "40-44, Male", "gender=M|age=40-44", "");
	SSEMRBaseDataSet.ColumnParameters female_40_to_44 = new SSEMRBaseDataSet.ColumnParameters(null, "40-44, Female", "gender=F|age=40-44", "");

	SSEMRBaseDataSet.ColumnParameters male_45_to_49 = new SSEMRBaseDataSet.ColumnParameters(null, "45-49, Male", "gender=M|age=45-49", "");
	SSEMRBaseDataSet.ColumnParameters female_45_to_49 = new SSEMRBaseDataSet.ColumnParameters(null, "45-49, Female", "gender=F|age=45-49", "");

	SSEMRBaseDataSet.ColumnParameters male_50_plus = new SSEMRBaseDataSet.ColumnParameters(null, "50+, Male", "gender=M|age=50+", "");
	SSEMRBaseDataSet.ColumnParameters female_50_plus = new SSEMRBaseDataSet.ColumnParameters(null, "50+, Female", "gender=F|age=50+", "");
