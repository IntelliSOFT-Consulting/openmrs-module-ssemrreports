...
@Component
public class TbScreeningAggregateDatasetDefinition extends SsemrBaseDataSet {
	...
	@Autowired
	public TbScreeningAggregateDatasetDefinition(CommonCohortQueries commonCohortQueries, SsemrCommonDimension dimension,
