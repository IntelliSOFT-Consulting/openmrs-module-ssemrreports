...
public class SetupArtMonthlyReport extends SSEMRDataExportManager {
	...
	public ReportDefinition constructReportDefinition() {
		...
		rd.addDataSetDefinition("CummAndNewOnArt", Mapped.mapStraightThrough(artDatasetDefinition.getTxCurrForAgeAtEnrolmentDataset()));
		rd.addDataSetDefinition("currentOnArtByAge",
		    Mapped.mapStraightThrough(artDatasetDefinition.getArtDataset()));
