...
public class SetupMerIndicatorsReport extends SSEMRDataExportManager {
	...
	@Autowired
	public SetupMerIndicatorsReport(org.openmrs.module.ssemrreports.reporting.library.datasets.MerIndicatorsDatasetDefinition merIndicatorsDatasetDefinition) {
